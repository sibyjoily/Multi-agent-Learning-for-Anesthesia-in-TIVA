...
# 加载数据
trajectory_train_general = pd.read_csv(predata_root + 'trajectory_train_Thoracic2.csv')
trajectory_test_general = pd.read_csv(predata_root + 'trajectory_test_Thoracic2.csv')
#############################
...
#####################################################加载模型########################################################
# 加载模型
rf_model = joblib.load(new_weight_root + 'rf_model_thoracic_1.pkl')
gbr_model = joblib.load(new_weight_root + 'gbr_model_thoracic_1.pkl')
xgboost_model = joblib.load(new_weight_root + 'xgboost_model_thoracic_1.pkl')
svr_pipeline = joblib.load(new_weight_root + 'svr_pipeline_thoracic_1.pkl')
#####################################################加载模型########################################################
...
#                 'Orchestra/RFTN20_CP', 'Solar8000/HR', 'Solar8000/ART_MBP', 'Solar8000/VENT_RR', 'Solar8000/BT']
column_names =['BIS', 'PPF_CE', 'PPF_CP', 'RFTN_CE',
...
def plot_feature_importance(feature_importances):
    ...
    # 保存图片
    plt.savefig(image_root + 'feature_importance_thoracic.pdf', format='pdf', bbox_inches='tight')
    # 显示图形
    plt.show()
...
# predictions_df.columns = ['BIS', 'PPF_CE', 'PPF20_CP', 'RFTN20_CE',
...
# 保存图片
plt.savefig(image_root + 'ml_rr_bt_thoracic.pdf', format='pdf', bbox_inches='tight')
plt.show()
...
ax.legend(loc='best', fontsize=11)
# 保存图片
plt.savefig(image_root + 'ml_cp_thoracic.pdf', format='pdf', bbox_inches='tight')
plt.show()
...
ax.legend(loc='best', fontsize=11)
#保存图片
plt.savefig(image_root + 'ml_bis_hr_mbp_thoracic.pdf', format='pdf', bbox_inches='tight')
plt.show()
...
ax.legend(loc='best', fontsize=11)
#保存图片
plt.savefig(image_root + 'ml_ce_thoracic.pdf', format='pdf', bbox_inches='tight')
plt.show()
...
#
# #保存每个特征的图片，pdf格式
# plt.savefig(image_root + 'BIS_BIS_thoracic.pdf', format='pdf', bbox_inches='tight')
# plt.savefig(image_root + 'Orchestra_PPF20_CE_thoracic.pdf', format='pdf', bbox_inches='tight')
# plt.savefig(image_root + 'Orchestra_PPF20_CP_thoracic.pdf', format='pdf', bbox_inches='tight')
# plt.savefig(image_root + 'Orchestra_RFTN20_CE_thoracic.pdf', format='pdf', bbox_inches='tight')
# plt.savefig(image_root + 'Orchestra_RFTN20_CP_thoracic.pdf', format='pdf', bbox_inches='tight')
# plt.savefig(image_root + 'Solar8000_HR_thoracic.pdf', format='pdf', bbox_inches='tight')
# plt.savefig(image_root + 'Solar8000_ART_MBP_thoracic.pdf', format='pdf', bbox_inches='tight')
# plt.savefig(image_root + 'Solar8000_VENT_RR_thoracic.pdf', format='pdf', bbox_inches='tight')
# plt.savefig(image_root + 'Solar8000_BT_thoracic.pdf', format='pdf', bbox_inches='tight')
########################################################################################################################
#
#
#
