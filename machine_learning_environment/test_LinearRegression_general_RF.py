...
#
# ################################################################################################################################################
# # metrics = ['BIS', 'PPF_CE', 'PPF_CP', 'RFTN_CE','RFTN_CP', 'HR', 'MBP', 'RR','BT']  # 这里列出了所有的度量标准
# # num_metrics = len(metrics)
# # colors=['#1ac938', '#e8000b', '#023eff', '#8b2be2', '#FFEB3B', '#a3a3a3', '#9f4800', '#ff7c00',  '#00d7ff']
# # # 将这些颜色分配给一个字典，这样每个度量标准都有一个颜色
# # palette = {metric: color for metric, color in zip(metrics, colors)}
# #
# # line_kws = {'linewidth': 1.5, 'solid_capstyle': 'round'}
# err_kws = {'alpha': 0.09}
# ################################################################################################################################################
#
#
...
# fig, ax = plt.subplots()
# # 为每个模型和指标选择一个颜色
# palette = sns.color_palette('bright', len(all_results_df['model'].unique()) * len(['RR','BT']))
# # 用于给线条命名的计数器
# color_count = 0
#
# for metric in ['RR','BT']:
...
# ax.legend(loc='best', fontsize=11)
# # 保存图片
# plt.savefig(image_root + 'ml_rr_bt_thoracic.pdf',  bbox_inches='tight')
# plt.show()
#
# ################################################################################################################################################
# # 创建图和y轴figsize=(15, 8)
...
# ax.legend(loc='best', fontsize=11)
# # 保存图片
# plt.savefig(image_root + 'ml_cp_thoracic.pdf',  bbox_inches='tight')
# plt.show()
#
# ################################################################################################################################################
# # 创建图和y轴figsize=(15, 8)
...
# ax.legend(loc='best', fontsize=11)
# #保存图片
# plt.savefig(image_root + 'ml_bis_hr_mbp_thoracic.pdf',  bbox_inches='tight')
# plt.show()
#
# ################################################################################################################################################
# # 创建图和y轴figsize=(15, 8)
...
# ax.legend(loc='lower center', fontsize=11)
# #保存图片
# plt.savefig(image_root + 'ml_ce_thoracic.pdf',  bbox_inches='tight')
# plt.show()
...
# plot_feature(predictions_df)
#
# #保存每个特征的图片，pdf格式
# plt.savefig(image_root + 'BIS_BIS_thoracic.pdf',  bbox_inches='tight')
# plt.savefig(image_root + 'Orchestra_PPF20_CE_thoracic.pdf',  bbox_inches='tight')
# plt.savefig(image_root + 'Orchestra_PPF20_CP_thoracic.pdf',  bbox_inches='tight')
# plt.savefig(image_root + 'Orchestra_RFTN20_CE_thoracic.pdf',  bbox_inches='tight')
# plt.savefig(image_root + 'Orchestra_RFTN20_CP_thoracic.pdf',  bbox_inches='tight')
# plt.savefig(image_root + 'Solar8000_HR_thoracic.pdf',  bbox_inches='tight')
# plt.savefig(image_root + 'Solar8000_ART_MBP_thoracic.pdf',  bbox_inches='tight')
# plt.savefig(image_root + 'Solar8000_VENT_RR_thoracic.pdf',  bbox_inches='tight')
# plt.savefig(image_root + 'Solar8000_BT_thoracic.pdf',  bbox_inches='tight')
########################################################################################################################
#
#
#
