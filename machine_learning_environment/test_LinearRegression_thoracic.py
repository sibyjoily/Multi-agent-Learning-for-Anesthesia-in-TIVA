...
# 加载数据
trajectory_train_general = pd.read_csv(predata_root + 'trajectory_train_general1.csv')
trajectory_test_general = pd.read_csv(predata_root + 'trajectory_test_general1.csv')
#############################
